...
/***/ "./client/src/components/Entry.less":
/*!******************************************!*\
  !*** ./client/src/components/Entry.less ***!
  \******************************************/
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/less-loader/dist/cjs.js!./Entry.less */ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry.less");
...
/***/ "./client/src/components/Entry.tsx":
/*!*****************************************!*\
  !*** ./client/src/components/Entry.tsx ***!
  \*****************************************/
/*! no static exports found */
...
var Entry = /** @class */ (function (_super) {
    ...
    Entry.prototype.render = function () {
        return (React.createElement("div", { className: "EntryPage" },
            React.createElement(InfoEntry_1.default, { payloadFunc: this.props.payloadFunc }),
            React.createElement(LoadingScreen_1.default, null)));
    };
    return Entry;
}(React.Component));
...
/***/ "./client/src/components/Entry/BookListing.less":
/*!******************************************************!*\
  !*** ./client/src/components/Entry/BookListing.less ***!
  \******************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../../node_modules/css-loader!../../../../node_modules/less-loader/dist/cjs.js!./BookListing.less */ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/BookListing.less");
...
/***/ "./client/src/components/Entry/BookListing.tsx":
/*!*****************************************************!*\
  !*** ./client/src/components/Entry/BookListing.tsx ***!
  \*****************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
__webpack_require__(/*! ./BookListing.less */ "./client/src/components/Entry/BookListing.less");
var BookListing = /** @class */ (function (_super) {
    __extends(BookListing, _super);
    function BookListing(props) {
        return _super.call(this, props) || this;
    }
    BookListing.prototype.componentDidMount = function () {
        console.log("RENDERING BOOKLIST");
        console.log(JSON.stringify(this.props.bookObj));
    };
    BookListing.prototype.render = function () {
        return (React.createElement("a", { className: "BookListing" },
            React.createElement("div", { className: "ImgHolder" },
            ...
            React.createElement("div", { className: "TextHolder" },
                React.createElement("div", null,
                    ...
                    React.createElement("br", null),
                    React.createElement("span", { className: "Relevance" },
                        "Score: ",
                        this.props.bookObj["score"])))));
    };
    return BookListing;
}(React.Component));
exports.default = BookListing;


/***/ }),

/***/ "./client/src/components/Entry/InfoEntry.less":
/*!****************************************************!*\
  !*** ./client/src/components/Entry/InfoEntry.less ***!
  \****************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../../node_modules/css-loader!../../../../node_modules/less-loader/dist/cjs.js!./InfoEntry.less */ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/InfoEntry.less");
...
/***/ "./client/src/components/Entry/InfoEntry.tsx":
/*!***************************************************!*\
  !*** ./client/src/components/Entry/InfoEntry.tsx ***!
  \***************************************************/
/*! no static exports found */
...
var InfoEntry = /** @class */ (function (_super) {
    ...
    InfoEntry.prototype.handleSearchChange = function (event) {
        this.setState({
            searchArea: event.target.value
        });
    };
    InfoEntry.prototype.searchBooks = function () {
        var _this = this;
    ...
    InfoEntry.prototype.searchToBooks = function () {
        var _this = this;
        var queryLim = 10;
        var _loop_1 = function (i) {
            axios_1.default.post("/books/" + this_1.state.recentSearch[i].ref).then(function (response) {
                _this.addBook(response.data, _this.state.recentSearch[i]);
            });
        };
        var this_1 = this;
        for (var i = 0; i < queryLim; i++) {
            _loop_1(i);
        }
    };
    InfoEntry.prototype.addBook = function (bookObj, searchResults) {
        this.setState({
            books: this.state.books.concat([
                __assign({}, bookObj[0], { score: searchResults.score })
            ])
        });
    };
    InfoEntry.prototype.removeBooks = function () {
        this.setState({
            books: []
        });
    };
    InfoEntry.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "InfoEntryPage" },
            React.createElement("div", { className: "InfoContainer" },
                ...
                React.createElement("div", { className: "InfoDataSection" },
                    React.createElement("h3", null, "Search Books"),
                    ...
                    React.createElement("button", { onClick: function () { _this.searchBooks(); } }, "Submit")),
                React.createElement("div", { className: "InfoSearchedBooks" },
                    ...
                    this.state.books.map(function (val) {
                        ...
                        return (React.createElement(BookListing_1.default, { bookObj: val, callBackFunction: _this.props.payloadFunc }));
                        // });
                    })))));
    };
    return InfoEntry;
...
/***/ "./client/src/components/Entry/LoadingScreen.less":
/*!********************************************************!*\
  !*** ./client/src/components/Entry/LoadingScreen.less ***!
  \********************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../../node_modules/css-loader!../../../../node_modules/less-loader/dist/cjs.js!./LoadingScreen.less */ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/LoadingScreen.less");
...
/***/ "./client/src/components/Entry/LoadingScreen.tsx":
/*!*******************************************************!*\
  !*** ./client/src/components/Entry/LoadingScreen.tsx ***!
  \*******************************************************/
/*! no static exports found */
...
var LoadingScreen = /** @class */ (function (_super) {
    ...
    LoadingScreen.prototype.render = function () {
        return (React.createElement("div", { className: "LoadingScreenPage" },
            React.createElement("h1", null, "LoadingScreenPage")));
    };
...
/***/ "./client/src/components/Result.less":
/*!*******************************************!*\
  !*** ./client/src/components/Result.less ***!
  \*******************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/less-loader/dist/cjs.js!./Result.less */ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Result.less");
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
__webpack_require__(/*! ./Result.less */ "./client/src/components/Result.less");
var Results = /** @class */ (function (_super) {
    ...
    Results.prototype.render = function () {
        return (React.createElement("div", { className: "ResultPage" },
            React.createElement("h1", null, "ResultPage")));
    };
    return Results;
}(React.Component));
...
var Entry_1 = __webpack_require__(/*! ./components/Entry */ "./client/src/components/Entry.tsx");
var Result_1 = __webpack_require__(/*! ./components/Result */ "./client/src/components/Result.tsx");
var Root = /** @class */ (function (_super) {
    __extends(Root, _super);
    function Root() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Root.prototype.componentDidMount = function () { console.log("[CORE] React has loaded"); };
    Root.prototype.componentWillMount = function () { console.log("[CORE] React will load"); };
    Root.prototype.searchTrig = function () {
    };
    Root.prototype.render = function () {
        return (React.createElement("div", { className: "app" },
            React.createElement(Entry_1.default, { payloadFunc: this.searchTrig }),
...
/***/ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry.less":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry.less ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/BookListing.less":
/*!***********************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/BookListing.less ***!
  \***********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/InfoEntry.less":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/InfoEntry.less ***!
  \*********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/LoadingScreen.less":
/*!*************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/less-loader/dist/cjs.js!./client/src/components/Entry/LoadingScreen.less ***!
  \*************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/less-loader/dist/cjs.js!./client/src/components/Result.less":
/*!************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/less-loader/dist/cjs.js!./client/src/components/Result.less ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".ResultPage {\n  width: 100vw;\n  height: 100vh;\n}\n", ""]);
