...
var BookListing = /** @class */ (function (_super) {
    ...
    BookListing.prototype.render = function () {
        var _this = this;
        return (React.createElement("a", { href: "#", onClick: function (event) { event.preventDefault(); _this.props.frontEnd.bookSelected(_this.props.bookObj); }, className: "BookListing" },
...
var Root = /** @class */ (function (_super) {
    ...
    function Root(props) {
        ...
        _this.showResultsPage = _this.showResultsPage.bind(_this);
        return _this;
    }
    ...
    Root.prototype.showResultsPage = function (state) {
        this.setState({
            showResults: state
        });
    };
    Root.prototype.render = function () {
        return (React.createElement("div", { className: "app" }, this.state.showResults ? React.createElement(Result_1.default, { frontEnd: this.frontEndController }) : React.createElement(Entry_1.default, { frontEnd: this.frontEndController })));
    };
    return Root;
}(React.Component));
...
var FrontEndController = /** @class */ (function () {
    ...
    FrontEndController.prototype.mountInputState = function (loading) {
